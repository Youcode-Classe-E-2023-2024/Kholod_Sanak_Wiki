...
<div class="flex h-screen w-full bg-gray-800 " >
    ...
    <div class="flex flex-col flex-1 w-full overflow-y-auto">
            ...
            <div class="grid gap-2 grid-cols-1 lg:grid-cols-1">
                <div class="bg-white p-4 shadow-lg rounded-lg">
                    <div class="flex justify-between">
                        ...
                        <button  id="adduser-btn" class=" mb-5 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Add User
                        </button>
                    </div>
                    <div class="mt-4">
        ...
        <?php include "views/userform_view.php";?>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                <div class="flex space-x-4">
                                    <button  id="edit-user" class="text-blue-500 hover:text-blue-600 "
                                    ...
                                    <button  class=" delete_user text-red-500 hover:text-red-600"
                                                data-user-id="${user.user_id}">
