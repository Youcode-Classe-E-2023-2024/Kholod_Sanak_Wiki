...
<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
   ...
   <a class="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200" href="index.php?page=login">Sign up</a>
    <!-- when it is logged -->
